  ...
  <div class="site-shell">
    <header class="site-header">
      <RouterLink class="brand-lockup" to="/">
        <img class="brand-logo" src="/favicon.ico" alt="YXTI" aria-hidden="true" />
    ...
    <footer v-if="showFooter" class="site-footer">
      <div class="footer-content">
        ...
        <div class="footer-section">
          ...
          <p class="footer-note" style="margin-top: 8px;" v-if="false">
        ...
        <div class="footer-section">
          ...
          <p class="footer-note">{{ t('app.footer.notes.saurlaxCreditBefore') }}<a href="https://github.com/tianxingleo/ACGTI" target="_blank" rel="noopener noreferrer" style="color: #3ba17c; text-decoration: none; font-weight: 600;">ACGTI</a>{{ t('app.footer.notes.saurlaxCreditAfter') }}</p>
          <p class="footer-note" v-if="false">{{ t('app.footer.notes.sowieeeCreditBefore') }}<a href="https://github.com/SoWiEee" target="_blank" rel="noopener noreferrer" style="color: #3ba17c; text-decoration: none; font-weight: 600;">SoWiEee</a>{{ t('app.footer.notes.sowieeeCreditAfter') }}</p>
        </div>
        <div class="footer-section author-social-section" v-if="false">
      ...
      <div class="footer-bottom">
        <p class="footer-copyright">© 2026 YXTI Project</p>
        <div class="footer-social">
          ...
          <RouterLink to="/sponsor" :title="t('app.footer.social.sponsor')" v-if="false">{{ t('app.footer.social.sponsor') }}</RouterLink>
        </div>
      </div>
    </footer>
  </div>
