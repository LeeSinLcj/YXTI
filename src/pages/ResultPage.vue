        ...
        <div class="hero-copy type-box">
          ...
          <div class="hero-actions-container">
            ...
            <div class="hero-actions secondary">
              ...
              <RouterLink to="/sponsor" class="action-btn ghost" style="text-decoration: none;" v-if="false">
              ...
              <a href="https://github.com/tianxingleo/ACGTI" target="_blank" rel="noopener noreferrer" class="action-btn ghost" style="text-decoration: none;" v-if="false">
