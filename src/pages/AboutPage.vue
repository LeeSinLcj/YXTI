...
const faqJsonLd = computed(() => [
  ...
  },
  {
    ...
    description: '以 MBTI 为基础的弈仙牌角色原型测试工具，通过情境式问题生成专属角色代码和原型报告。',
...
useSeo({
  title: '关于 YXTI - Yi Xian Type Indicator 弈仙牌人格测试 | 项目说明与常见问题',
  description: 'YXTI（Yi Xian Type Indicator）二创自ACGTI，是以 MBTI 为基础的弈仙牌角色原型测试工具。30 道情境题、8 大原型、23 位角色，支持中英日多语言。了解项目定位、当前功能、技术边界与常见问题。',
  path: '/about',
  jsonLd: faqJsonLd,
})
</script>
      ...
      <div class="page-stack">
        <section class="intro-block" v-reveal>
          ...
          <div class="action-wrap">
            ...
            <p class="action-note" v-if="false">
