...
useSeo({
  title: 'YXTI 介绍页 - Yi Xian Type Indicator | 测试说明',
  description: '了解 YXTI（Yi Xian Type Indicator）的测试规则、隐私说明和分享方式；如需查看项目说明，请前往关于页面。',
  path: '/intro',
})
    ...
    <div class="intro-layout">
      <div class="page-stack">
        ...
        <section class="intro-block center-align" v-reveal>
          ...
          <p class="brand-line">YXTI 介绍页 · Yi Xian Type Indicator</p>
